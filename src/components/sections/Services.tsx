...
const Services = () => {
  ...
  return (
    <section>
      <div
        className={twMerge(
          "max-page-width flex flex-col gap-4 px-4 py-12 md:gap-8 md:py-24",
        )}
      >
        <h2 className="max-w-3xl text-balance text-2xl font-medium sm:text-3xl md:text-4xl">
          Vad vi gör
        </h2>
        <p className="max-w-3xl text-balance text-lg">
          Vårt utbud av tjänster omfattar allt från takbehandling och
          takrengöring till fasadrengöring och fasadbehandling.
        </p>
